 ...
 const handleSubmit = async () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-8 bg-white shadow-md rounded-xl">
      <ToastContainer />
      <h2 className="text-2xl font-bold mb-2 text-blue-600">Submit a Support Request</h2>
      <p className="text-gray-600 mb-6">
        Need help with your device? Fill out the form below and one of our technicians will be in touch with you shortly.
      </p>

      <div className="space-y-4">
        <div>
          <label className="block font-medium text-sm text-gray-700 mb-1">Device Type</label>
          <input
        ...
        <div>
          <label className="block font-medium text-sm text-gray-700 mb-1">Issue Description</label>
          <textarea
        ...
        <div>
          <label className="block font-medium text-sm text-gray-700 mb-1">Preferred Repair Date</label>
          <input
            type="date"
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400"
            value={scheduled}
      ...
      <div className="mt-8 text-sm text-gray-500">
        ...
        <p className="mt-2">Need immediate assistance? <a href="/support/chat" className="text-blue-600 hover:underline">Start a live chat</a>.</p>
      </div>
    </div>
  );
}
